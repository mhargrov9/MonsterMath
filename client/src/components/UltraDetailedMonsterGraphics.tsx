    ...
    return (
      ...
      >
        ...
        <g>
          {/* Left wing */}
          <path
            d="M80 150 Q30 100 20 160 Q25 220 70 200 Q100 180 120 150 Q110 140 100 130 Q90 140 80 150"
          ...
          <ellipse
            ...
            fill="#FF8C00"
            opacity="0.8"
            transform="rotate(-25 25 135)"
          />

          {/* Right wing */}
          <path
            d="M320 150 Q370 100 380 160 Q375 220 330 200 Q300 180 280 150 Q290 140 300 130 Q310 140 320 150"
            fill="url(#wingGradient)"
            stroke="#8B0000"
            strokeWidth="2"
          />
        ...
        {/* Feather crest */}
        <path
          d="M185 95 Q190 85 195 95"
          fill="#FFD700"
          stroke="#8B0000"
          strokeWidth="0.5"
        />
        <path
          d="M195 95 Q200 80 205 95"
          fill="#FF8C00"
          stroke="#8B0000"
          strokeWidth="0.5"
        />
        <path
          d="M205 95 Q210 85 215 95"
          fill="#FFD700"
          stroke="#8B0000"
          strokeWidth="0.5"
        />
        ...
        {/* Phoenix beak */}
        <path
          d="M200 135 L185 145 Q190 150 200 145 Q210 150 215 145 L200 135"
        ...
        {/* Talons */}
        <path
          d="M175 330 Q170 335 175 340"
          stroke="#8B4513"
          strokeWidth="2"
          fill="#FFD700"
        />
        <path
          d="M180 335 Q175 340 180 345"
          stroke="#8B4513"
          strokeWidth="2"
          fill="#FFD700"
        />
        <path
          d="M185 330 Q180 335 185 340"
          stroke="#8B4513"
          strokeWidth="2"
          fill="#FFD700"
        />
        ...
        <path
          d="M225 330 Q230 335 225 340"
          stroke="#8B4513"
          strokeWidth="2"
          fill="#FFD700"
        />
        <path
          d="M220 335 Q225 340 220 345"
          stroke="#8B4513"
          strokeWidth="2"
          fill="#FFD700"
        />
        <path
          d="M215 330 Q220 335 215 340"
          stroke="#8B4513"
          strokeWidth="2"
          fill="#FFD700"
        />
        ...
        {tailType === 'flame' ? (
          <g>
            <path
              d="M200 310 Q180 340 160 370 Q170 380 190 350 Q200 330 200 310"
              fill="#FFD700"
              opacity="0.8"
            />
            <path
              d="M200 310 Q220 340 240 370 Q230 380 210 350 Q200 330 200 310"
              fill="#FF8C00"
              opacity="0.8"
            />
            <path d="M200 310 Q200 350 200 390" fill="#FF4500" opacity="0.7" />
          </g>
        ) : (
          <g>
            <path
              d="M200 310 Q185 350 170 380"
              stroke="#8B0000"
              strokeWidth="3"
              fill="#FF6347"
            />
            <path
              d="M200 310 Q200 350 200 380"
              stroke="#8B0000"
              strokeWidth="3"
              fill="#FFD700"
            />
            <path
              d="M200 310 Q215 350 230 380"
              stroke="#8B0000"
              strokeWidth="3"
              fill="#FF6347"
            />
  ...
  const renderAquaLeviathan = () => {
    ...
    return (
      ...
      >
        ...
        <g>
          <path
            d="M120 180 Q70 160 60 200 Q70 240 110 220 Q115 200 120 180"
            fill="url(#finGradient)"
            stroke="#2F4F4F"
            strokeWidth="2"
          />
          <path
            d="M280 180 Q330 160 340 200 Q330 240 290 220 Q285 200 280 180"
            fill="url(#finGradient)"
            stroke="#2F4F4F"
            strokeWidth="2"
          />
        ...
        {/* Powerful tail */}
        <path
          d="M200 350 Q170 380 150 400 Q200 410 250 400 Q230 380 200 350"
          fill="url(#finGradient)"
        />
    ...
    return (
      ...
      >
        ...
        {hasWings && (
          <g>
            <path
              d="M120 120 Q60 80 40 140 Q50 200 100 180 Q110 150 120 120"
              fill="url(#stormWing)"
              stroke="#4B0082"
              strokeWidth="3"
            />
            <path
              d="M120 120 Q80 110 60 130 Q70 150 90 140 Q105 130 120 120"
              fill="url(#stormWing)"
              opacity="0.8"
            />

            <path
              d="M280 120 Q340 80 360 140 Q350 200 300 180 Q290 150 280 120"
              fill="url(#stormWing)"
              stroke="#4B0082"
              strokeWidth="3"
            />
            <path
              d="M280 120 Q320 110 340 130 Q330 150 310 140 Q295 130 280 120"
              fill="url(#stormWing)"
              opacity="0.8"
            />
          </g>
        ...
        {/* Complex horn array */}
        <polygon
          points="200,90 210,110 190,110"
          fill="url(#hornGradient)"
          stroke="#654321"
          strokeWidth="1"
        />
        <polygon
          points="175,95 185,115 165,115"
          fill="url(#hornGradient)"
          stroke="#654321"
          strokeWidth="1"
        />
        <polygon
          points="225,95 235,115 215,115"
          fill="url(#hornGradient)"
          stroke="#654321"
          strokeWidth="1"
        />
        ...
        {hasSharpTeeth ? (
          <g>
            <polygon
              points="180,165 185,180 190,165"
              fill="#FFFFFF"
              stroke="#C0C0C0"
              strokeWidth="0.5"
            />
            <polygon
              points="190,165 195,185 200,165"
              fill="#FFFFFF"
              stroke="#C0C0C0"
              strokeWidth="0.5"
            />
            <polygon
              points="200,165 205,185 210,165"
              fill="#FFFFFF"
              stroke="#C0C0C0"
              strokeWidth="0.5"
            />
            <polygon
              points="210,165 215,180 220,165"
              fill="#FFFFFF"
              stroke="#C0C0C0"
              strokeWidth="0.5"
            />
        ...
        {/* Individual claws */}
        <path
          d="M125 245 Q120 235 128 232"
          stroke="#2F4F4F"
          strokeWidth="2"
          fill="#708090"
        />
        <path
          d="M130 242 Q125 232 133 229"
          stroke="#2F4F4F"
          strokeWidth="2"
          fill="#708090"
        />
        <path
          d="M135 245 Q130 235 138 232"
          stroke="#2F4F4F"
          strokeWidth="2"
          fill="#708090"
        />
        ...
        <path
          d="M275 245 Q280 235 272 232"
          stroke="#2F4F4F"
          strokeWidth="2"
          fill="#708090"
        />
        <path
          d="M270 242 Q275 232 267 229"
          stroke="#2F4F4F"
          strokeWidth="2"
          fill="#708090"
        />
        <path
          d="M265 245 Q270 235 262 232"
          stroke="#2F4F4F"
          strokeWidth="2"
          fill="#708090"
        />
        ...
        {tailType === 'spiked' ? (
          <g>
            ...
            <ellipse
              ...
              ry="30"
              fill="url(#dragonBody)"
              transform="rotate(-35 180 370)"
            />
            <polygon
              points="185,325 192,315 199,325"
              fill="#C0C0C0"
              stroke="#808080"
            />
            <polygon
              points="175,355 182,345 189,355"
              fill="#C0C0C0"
              stroke="#808080"
            />
          </g>
        ...
        <g opacity="0.8">
          <path
            d="M230 155 L250 150 L245 160 L265 155 L260 165 L280 160"
            stroke="#FFFF00"
            strokeWidth="3"
            fill="none"
          />
    ...
    return (
      ...
      >
        ...
        {hasWings && (
          <g>
            <path
              d="M120 140 Q70 120 50 170 Q60 220 100 200 Q110 170 120 140"
            ...
            <path
              d="M280 140 Q330 120 350 170 Q340 220 300 200 Q290 170 280 140"
              fill="url(#crystalGradient)"
              stroke="#9370DB"
              strokeWidth="3"
              opacity="0.8"
        ...
        <polygon
          points="200,180 230,200 200,240 170,200"
          fill="url(#crystalGradient)"
          stroke="#9370DB"
          strokeWidth="3"
        />
        ...
        <polygon
          points="170,100 175,85 180,100"
          fill="url(#crystalGradient)"
          stroke="#9370DB"
        />
        <polygon
          points="195,95 200,80 205,95"
          fill="url(#crystalGradient)"
          stroke="#9370DB"
        />
        <polygon
          points="220,100 225,85 230,100"
          fill="url(#crystalGradient)"
          stroke="#9370DB"
        />
        ...
        <polygon
          points="180,118 186,125 180,132 174,125"
          fill="url(#crystalGradient)"
        />
        <polygon
          points="220,118 226,125 220,132 214,125"
          fill="url(#crystalGradient)"
        />
        ...
        {hasSharpTeeth ? (
          <g>
            <polygon
              points="175,165 180,180 185,165"
              fill="url(#crystalGradient)"
              stroke="#9370DB"
            />
            <polygon
              points="185,165 190,185 195,165"
              fill="url(#crystalGradient)"
              stroke="#9370DB"
            />
            <polygon
              points="195,165 200,185 205,165"
              fill="url(#crystalGradient)"
              stroke="#9370DB"
            />
            <polygon
              points="205,165 210,185 215,165"
              fill="url(#crystalGradient)"
              stroke="#9370DB"
            />
            <polygon
              points="215,165 220,180 225,165"
              fill="url(#crystalGradient)"
              stroke="#9370DB"
            />
          </g>
        ...
        {tailType === 'crystal' ? (
          <g>
            ...
            <polygon
              points="190,370 200,350 210,370"
              fill="url(#crystalGradient)"
              stroke="#9370DB"
            />
            <polygon
              points="185,385 200,365 215,385"
              fill="url(#crystalGradient)"
              stroke="#9370DB"
            />
          </g>
