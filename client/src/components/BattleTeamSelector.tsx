...
_**<div className="text-center py-2 text-sm text-white/70 font-medium">Max Level</div>**_
)}
</div>
</div>
))
...
// FIX: This hook ensures fresh data is fetched when the component loads.
useEffect(() => {
queryClient.invalidateQueries({ queryKey: ["/api/user/monsters"] });
}, []);
