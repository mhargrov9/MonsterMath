...
> = {
  Node_01_Awakening: {
    ...
    content:
      'The echo of the terrifying vision fades. You find yourself in a familiar glade, but the air is heavy with a silent dread... A strange, psychic hum buzzes at the edge of your thoughts. You are alone.',
    choices: [
      { text: 'Look for the other monsters', nextNode: 'Node_02_Discovery' },
      {
        text: 'Investigate the source of the hum',
        nextNode: 'Node_02_Discovery',
      },
    ],
  ...
  Node_02_Discovery: {
    ...
    content:
      'You are drawn to an ancient tree... Half-buried in its roots is a crystalline shard, glowing with a soft, warm light. It pulses in rhythm with the hum in your mind, and you feel a sense of profound sadness and loneliness coming from it...',
    choices: [
      { text: 'Gently touch the Shard', nextNode: 'Node_03_Conversation' },
      {
        text: 'Call out to it with your thoughts',
        nextNode: 'Node_03_Conversation',
      },
    ],
    location: 'The Whispering Glade',
    image: '@assets/The Whispering Glade_1750207549359.png',
  ...
  Node_03_Conversation: {
    ...
    choices: [
      {
        text: 'Continue listening to the Shard',
        nextNode: 'Node_04_Crossroads',
      },
    ],
    location: 'The Whispering Glade',
    image: '@assets/The Whispering Glade_1750207549359.png',
  ...
  Node_04_Crossroads: {
    ...
    content:
      "The Shard says: 'I sense safety and other free monsters towards the village... but I also feel a strange, forgotten power emanating from those old ruins. The choice is yours. Where should we go?'",
    choices: [
      {
        text: 'Head towards Elderwood Village',
        nextNode: 'Node_5A_Village_Arrival',
      },
      {
        text: 'Investigate the Old Training Yard',
        nextNode: 'Node_5B_Yard_Arrival',
      },
    ],
  ...
  Node_5A_Village_Arrival: {
    ...
    content:
      "You arrive at the village gates. It feels safe from the strange energy in the forest, but it's also tense. No one is out in the open. You see a nervous monster peeking out from behind a market stall.",
    choices: [
      {
        text: 'Approach the nervous monster',
        nextNode: 'Node_6A_Elder_Meeting',
      },
  ...
  Node_7A_Den_Entrance: {
    ...
    content:
      "The Elder guides you to the den and wishes you luck before retreating to safety. The Shard of Remembrance hums in your mind, 'There are several of Vorvax's creatures in there. They feel... like freshly broken stone and shadows. Be ready for a fight. How do we approach?'",
    choices: [
      {
        text: 'Enter the den cautiously, ready to ambush',
        nextNode: 'Node_8A_Inner_Chamber',
      },
      {
        text: 'Charge in aggressively, letting out a battle cry',
        nextNode: 'Node_8A_Inner_Chamber',
      },
    ],
  ...
  Node_8A_Inner_Chamber: {
    ...
    content:
      "After defeating the scouts, you push deeper into the cavern. A tougher-looking 'Scout Commander' stands guard over a crude wooden chest. It snarls, recognizing the light of the Shard as a threat. 'For the glory of Vorvax!' it screeches as it lunges!",
    choices: [
  ...
  Node_5B_Yard_Arrival: {
    ...
    content:
      "You arrive at the crumbling remains of what was once a grand training facility. Broken statues of legendary monsters stand sentinel over overgrown combat rings. The Shard grows brighter. 'This place... I remember training here, long ago. But something stirs in the shadows...'",
    choices: [
  ...
  Node_6B_Confrontation: {
    ...
    content:
      "As you explore, shadow creatures materialize from the ruins! Their leader, a corrupted monster with glowing red eyes, speaks: 'The Shard belongs to Master Vorvax! Surrender it now!' The Shard pulses with defiant energy. 'These servants cannot be reasoned with. We must fight or flee!'",
    choices: [
      {
        text: 'Stand and fight the shadows',
        nextNode: 'Node_7B_Battle_Outcome',
      },
      {
        text: 'Try to escape through the ruins',
        nextNode: 'Node_7B_Battle_Outcome',
      },
    ],
    location: 'The Ruined Training Yard',
  ...
  Node_7B_Battle_Outcome: {
    ...
    choices: [
      {
        text: 'Learn about these ancient locations',
        nextNode: 'Node_08_Great_Choice',
      },
    ],
    location: 'The Ruined Training Yard',
  ...
  Node_08_Great_Choice: {
    ...
    content:
      'The Shard says: "Wait... now that I know what to look for, I can sense more of Vorvax\'s power. There are two other locations just as powerful as the Sunken Temple... a Sky Spire that crackles with lightning, and a Volcanic Forge that burns with ancient rage. All three are connected. We must conquer them all to face Vorvax, but we can only choose one path now."',
    choices: [
  ...
  Node_09_Cliffhanger: {
    ...
    content:
      'You have completed the first chapter of your adventure! The journey to save the Monster World begins now. Subscribe to continue.',
    choices: [],
...
export default function StoryManager() {
  ...
  const baseStory =
    STORY_NODES[currentNode] || STORY_NODES['Node_01_Awakening'];
  const currentStory = {
    ...baseStory,
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-fredoka text-electric-blue">
            {currentStory.title}
          </h2>
          <div className="flex items-center gap-2 mt-1">
            <Badge
              variant="outline"
              className="bg-lime-green/20 text-lime-green border-lime-green/50"
            >
            ...
            <Badge
              variant="outline"
              className="bg-vibrant-purple/20 text-vibrant-purple border-vibrant-purple/50"
            >
      ...
      <div className="relative">
        ...
        <div className="relative bg-gradient-to-br from-amber-50 via-yellow-50 to-amber-100 dark:from-amber-950 dark:via-yellow-950 dark:to-amber-900 border-4 border-amber-600/60 dark:border-amber-400/60 rounded-3xl shadow-2xl">
          ...
          <div className="absolute top-2 left-2 text-2xl text-amber-600/70 dark:text-amber-400/70">
            ✦
          </div>
          <div className="absolute top-2 right-2 text-2xl text-amber-600/70 dark:text-amber-400/70">
            ✦
          </div>
          <div className="absolute bottom-2 left-2 text-2xl text-amber-600/70 dark:text-amber-400/70">
            ✦
          </div>
          <div className="absolute bottom-2 right-2 text-2xl text-amber-600/70 dark:text-amber-400/70">
            ✦
          </div>
                  ...
                  <div className="relative bg-gradient-to-br from-amber-100 to-yellow-200 dark:from-amber-900 dark:to-yellow-800 border-4 border-amber-500/70 dark:border-amber-400/70 rounded-2xl p-6 shadow-inner">
                    <div className="w-full h-48 sm:h-64 bg-gradient-to-br from-amber-200/50 to-yellow-300/50 dark:from-amber-800/50 dark:to-yellow-700/50 rounded-xl border-2 border-amber-400/50 dark:border-amber-500/50 relative overflow-hidden">
                      ...
                      {currentStory.image.startsWith('@assets/') ? (
                        <img
                          src={currentStory.image.replace(
                            '@assets/',
                            '/attached_assets/',
                          )}
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-serif text-slate-800 dark:text-slate-200 font-medium">
                      Return to{' '}
                      {STORY_NODES[NODE_PARENTS[currentNode]]?.title ||
                        NODE_PARENTS[currentNode]}
                    </span>
                  </div>
                </button>
            ...
            {currentNode === 'Node_09_Cliffhanger' ? (
              <div className="space-y-6">
                <div className="text-center p-8 bg-gradient-to-br from-purple-200 via-blue-200 to-purple-300 dark:from-purple-900 dark:via-blue-900 dark:to-purple-800 border-4 border-purple-500/60 dark:border-purple-400/60 rounded-2xl shadow-inner relative">
                  <div className="absolute top-2 left-2 text-purple-600/70 dark:text-purple-400/70">
                    ★
                  </div>
                  <div className="absolute top-2 right-2 text-purple-600/70 dark:text-purple-400/70">
                    ★
                  </div>
                  ...
                  <p className="text-purple-700 dark:text-purple-300 mb-6 font-serif italic">
                    Your adventure has just begun. The mysteries of Vorvax and
                    the ancient locations await...
                  </p>
                  <button
                    onClick={resetStory}
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-4 mt-6">
                  {currentStory.choices?.map((choice, index) => (
                    ...
                    >
                      <div className="absolute top-1 left-1 text-amber-600/50 dark:text-amber-400/50 text-xs">
                        ✦
                      </div>
                      <div className="absolute top-1 right-1 text-amber-600/50 dark:text-amber-400/50 text-xs">
                        ✦
                      </div>
      ...
      <Card className="bg-gold-yellow/10 border-gold-yellow/30">
        ...
        <CardContent>
          <CardDescription className="text-gray-600">
            This story system automatically saves your progress to the database.
            When you make choices, your current story node (like "{currentNode}
            ") is saved to your user profile. If you log out and log back in,
            you'll continue exactly where you left off in your adventure.
          </CardDescription>
        </CardContent>
      </Card>
    </div>
