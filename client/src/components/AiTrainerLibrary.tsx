...
export default function AiTrainerLibrary({
  onSelectTrainer,
  playerTPL,
}: AiTrainerLibraryProps) {
    ...
    <Card>
      <CardHeader>
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          Your Team Power Level: {playerTPL} | Available Opponents:{' '}
        ...
        {availableTrainers.length === 0 ? (
          <div className="text-center py-8">
            <p className="text-gray-500 dark:text-gray-400">
              No trainers available for your current Team Power Level. Try
              ...
              >
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge
                      className={`${getArchetypeColor(trainer.archetype)} text-white`}
                    >
