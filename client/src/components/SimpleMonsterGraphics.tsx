  ...
  return (
    <div className="monster-graphics flex items-center justify-center bg-gray-100 rounded-lg p-2">
      <svg width={dimensions.width} height={dimensions.height} viewBox="0 0 200 200">
        <defs>
          <linearGradient id={`body-${monsterId}`} x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor={colors.primary}/>
            <stop offset="100%" stopColor={colors.secondary}/>
          </linearGradient>
          <linearGradient id={`head-${monsterId}`} x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        {/* Evolution aura */}
        {isEvolved && (
          <circle cx="100" cy="100" r="90" fill={`url(#aura-${monsterId})`} opacity="0.6"/>
        )}
        ...
        {/* Head */}
        <ellipse cx="100" cy="70" rx="35" ry="30" fill={`url(#head-${monsterId})`}/>
        ...
        {upgradeChoices.wings && (
          <>
            <path d="M65 90 Q40 70 45 110 Q60 100 75 105" fill={colors.accent} opacity="0.8"/>
            <path d="M135 90 Q160 70 155 110 Q140 100 125 105" fill={colors.accent} opacity="0.8"/>
          </>
        )}
