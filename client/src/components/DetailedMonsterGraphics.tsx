...
export default function DetailedMonsterGraphics({
    ...
    >
      ...
      {evolutionStage >= 3 && (
        <circle
          ...
          cy="100"
          r="90"
          fill={`url(#fire-glow-${monsterId}-${size})`}
          opacity="0.6"
        />
      )}
      ...
      {/* Eyebrow ridges */}
      <path
        d="M82 70 Q90 68 98 70"
        stroke={colors.secondary}
        strokeWidth="2"
        fill="none"
      />
      <path
        d="M102 70 Q110 68 118 70"
        stroke={colors.secondary}
        strokeWidth="2"
        fill="none"
      />
      ...
      {evolutionStage >= 2 && (
        <>
          <path
            d="M115 65 Q125 55 135 60 Q140 50 145 65 Q140 70 135 65 Q130 75 125 70 Q120 75 115 70"
            fill={colors.accent}
            opacity="0.8"
          />
          <path
            d="M115 67 Q120 62 125 67 Q130 62 135 67"
            fill={colors.primary}
            opacity="0.9"
          />
        </>
      ...
      {upgradeChoices?.tail ? (
        <g>
          <path
            d="M135 130 Q160 140 180 120 Q200 100 185 85"
      ...
      {upgradeChoices?.spikes && (
        <>
          <path
            d="M85 95 Q80 80 85 78 Q90 80 90 85 Q87 90 85 95"
            fill={colors.accent}
          />
          <path
            d="M100 90 Q95 75 100 73 Q105 75 105 80 Q102 85 100 90"
            fill={colors.accent}
          />
          <path
            d="M115 95 Q110 80 115 78 Q120 80 120 85 Q117 90 115 95"
            fill={colors.accent}
          />
        </>
      )}
      ...
      <g opacity="0.7">
        <path
          d="M75 120 Q80 115 85 118 Q90 113 95 118 Q100 115 105 118 Q110 113 115 118 Q120 115 125 120"
          stroke={colors.accent}
          strokeWidth="2"
          fill="none"
        />
        <path
          d="M80 135 Q85 130 90 133 Q95 128 100 133 Q105 130 110 133 Q115 128 120 133"
          stroke={colors.accent}
          strokeWidth="2"
          fill="none"
        />
  ...
  const renderThunderDrake = () => (
    ...
    >
      <defs>
        <linearGradient
          id={`thunder-body-${monsterId}-${size}`}
          x1="0%"
          y1="0%"
          x2="100%"
          y2="100%"
      ...
      {evolutionStage >= 3 && (
        <>
          <path
            d="M50 50 L60 70 L45 85 L55 105"
            stroke={colors.accent}
            strokeWidth="3"
            fill="none"
            opacity="0.6"
          />
          <path
            d="M150 50 L140 70 L155 85 L145 105"
            stroke={colors.accent}
            strokeWidth="3"
            fill="none"
            opacity="0.6"
      ...
      {upgradeChoices?.wings ? (
        <>
          <path
            d="M70 100 Q30 70 20 110 Q35 130 60 120 Q70 110 70 100"
            fill={colors.primary}
            opacity="0.8"
          />
          <path
            d="M130 100 Q170 70 180 110 Q165 130 140 120 Q130 110 130 100"
            fill={colors.primary}
            opacity="0.8"
          />
          {/* Wing details */}
          <path
            d="M40 90 Q30 100 40 110"
            stroke={colors.secondary}
            strokeWidth="2"
            fill="none"
          />
          <path
            d="M160 90 Q170 100 160 110"
            stroke={colors.secondary}
            strokeWidth="2"
            fill="none"
          />
        ...
        <>
          <path
            d="M75 105 Q50 90 45 115 Q55 125 70 120"
            fill={colors.primary}
            opacity="0.7"
          />
          <path
            d="M125 105 Q150 90 155 115 Q145 125 130 120"
            fill={colors.primary}
            opacity="0.7"
          />
        </>
      ...
      {evolutionStage >= 2 && (
        <path
          d="M112 68 L120 60 L115 55 L125 50 L120 45"
          stroke={colors.accent}
          strokeWidth="2"
          fill="none"
        />
      ...
      {upgradeChoices?.tail ? (
        <path
          d="M135 130 Q160 120 175 140 Q185 160 170 175"
          stroke={colors.primary}
          strokeWidth="10"
          fill="none"
        />
      ...
      <path
        d="M80 120 L90 130 L85 140 L95 150"
        stroke={colors.accent}
        strokeWidth="2"
        fill="none"
      />
      <path
        d="M120 120 L110 130 L115 140 L105 150"
        stroke={colors.accent}
        strokeWidth="2"
        fill="none"
      />
  ...
  const renderCrystalGuardian = () => (
    ...
    >
      <defs>
        <linearGradient
          id={`crystal-body-${monsterId}-${size}`}
          x1="0%"
          y1="0%"
          x2="100%"
          y2="100%"
      ...
      <polygon
        points="100,85 140,115 130,155 70,155 60,115"
      ...
      <polygon
        points="100,95 120,110 110,140 90,140 80,110"
        fill={colors.accent}
        opacity="0.6"
      />
      <polygon
        points="100,105 115,115 108,135 92,135 85,115"
        fill="white"
        opacity="0.4"
      />
      ...
      <polygon
        points="100,60 120,75 115,95 85,95 80,75"
        fill={colors.primary}
      />
      ...
      <polygon
        points="125,155 130,170 120,170 115,155"
  ...
  const renderWaterSprite = () => (
    ...
    >
      ...
      {/* Gills */}
      <path
        d="M70 75 Q75 80 70 85"
        stroke={colors.secondary}
        strokeWidth="2"
        fill="none"
      />
      <path
        d="M130 75 Q125 80 130 85"
        stroke={colors.secondary}
        strokeWidth="2"
        fill="none"
      />
      ...
      {/* Fins */}
      <path
        d="M70 90 Q50 95 55 110 Q65 105 70 100"
        fill={colors.primary}
        opacity="0.7"
      />
      <path
        d="M130 90 Q150 95 145 110 Q135 105 130 100"
        fill={colors.primary}
        opacity="0.7"
      />
      ...
      {upgradeChoices?.tail ? (
        <path
          d="M135 130 Q160 120 175 140 Q190 160 175 175 Q160 185 150 170"
          stroke={colors.primary}
          strokeWidth="12"
          fill="none"
          opacity="0.8"
        ...
        <path
          d="M130 130 Q150 125 160 140 Q170 155 160 165"
          stroke={colors.primary}
          strokeWidth="8"
          fill="none"
          opacity="0.8"
      ...
      {upgradeChoices?.spikes && (
        <>
          <polygon
            points="85,100 80,90 90,90"
            fill={colors.accent}
            opacity="0.8"
          />
          <polygon
            points="100,98 95,88 105,88"
            fill={colors.accent}
            opacity="0.8"
          />
          <polygon
            points="115,100 110,90 120,90"
            fill={colors.accent}
            opacity="0.8"
          />
        </>
      ...
      {/* Water swirls */}
      <path
        d="M75 125 Q85 120 95 125 Q105 130 115 125"
        stroke={colors.accent}
        strokeWidth="2"
        fill="none"
        opacity="0.6"
  ...
  const renderEarthGolem = () => (
    ...
    >
      ...
      {/* Cracks in the rock */}
      <path
        d="M75 120 L85 130 L80 140"
        stroke={colors.secondary}
        strokeWidth="1"
        fill="none"
      />
      <path
        d="M120 125 L110 135 L115 145"
        stroke={colors.secondary}
        strokeWidth="1"
        fill="none"
      />
  ...
  const renderMonster = () => {
    switch (monsterId) {
      ...
      case 2:
        return renderThunderDrake();
      case 3:
        return renderCrystalGuardian();
      case 4:
        return renderWaterSprite();
      case 5:
  ...
  return (
    ...
    >
      ...
      {evolutionStage > 1 && (
        <div
          className={`absolute -top-1 -right-1 bg-yellow-400 rounded-full flex items-center justify-center text-xs font-bold text-black border-2 border-white ${
            size === 'small'
              ? 'w-4 h-4 text-xs'
              : size === 'medium'
                ? 'w-5 h-5 text-xs'
